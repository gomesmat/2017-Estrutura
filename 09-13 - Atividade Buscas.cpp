...
int main(){
    ...
    printf("\n");
    printf(" Média de Buscas Sequencial: %.2f\n", contadorSeq/1000);
    printf(" Média de Buscas Binárias: %.2f\n", contadorBin/1000);
    printf(" Média de Buscas em Árvore Binária: %.2f\n", contadorArv/1000);
    printf(" Média de Buscas em Árvore AVL: %.2f\n", contadorArvAvl/1000);
    printf("\n");
